...
<title>Verify Your Email - INSPIN</title>
</head>
                            ...
                            <tr>
                                <td style="padding:36px 40px;">
                                    ...
                                    <p style="margin:0 0 24px;font-size:15px;color:rgba(255,255,255,.5);text-align:center;line-height:1.7;">
                                        Hi <strong style="color:#fff;">{{ $userName }}</strong>, welcome to INSPIN!<br>
                                        ...
                                        <tr>
                                            <td align="center" style="padding:8px 0 28px;">
                                                <a href="{{ $verificationUrl }}"
                                                   style="display:inline-block;padding:15px 40px;background:#FDB515;color:#000000;font-size:15px;font-weight:700;text-decoration:none;border-radius:50px;letter-spacing:.3px;">
                                    ...
                                    <p style="margin:20px 0 0;font-size:12px;color:rgba(255,255,255,.25);text-align:center;line-height:1.6;">
                                        ...
                                        <a href="{{ $verificationUrl }}" style="color:#FDB515;word-break:break-all;">{{ $verificationUrl }}</a>
                                    </p>
