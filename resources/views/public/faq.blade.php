...
@section('title', "FAQ's | Sportshandicapper")
@section('meta', 'Frequently asked questions about Sportshandicapper. Launching soon.')
    ...
    <div style="position:relative;max-width:576px;width:100%;text-align:center;">
        ...
        <div style="position:relative;">
            ...
            <p style="margin-top:24px;color:#94a3b8;line-height:1.7;font-size:15px;">
                Answers to the most common questions about picks, packages, and how Sportshandicapper works. In the meantime, reach out through our Communications Center.
            </p>

            <div style="margin-top:40px;display:flex;gap:16px;justify-content:center;flex-wrap:wrap;">
                <a href="{{ route('contact') }}" style="display:inline-flex;align-items:center;gap:8px;font-size:14px;color:#67e8f9;text-decoration:none;transition:color .15s;" onmouseover="this.style.color='white'" onmouseout="this.style.color='#67e8f9'">
                    Contact Us
