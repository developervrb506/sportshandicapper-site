...
<div style="max-width:860px;margin:0 auto;padding:0 24px;">
    ...
    $sections = [
        ...
        ['1. Terms of Service', 'Sportshandicapper.com provides the Website, the Content, and the Services to you subject to the following Terms of Service ("TOS"). The TOS may be updated by us from time to time without notice to you. We suggest that from time to time you review the TOS for possible changes.'],
        ['2. Services and Content', 'Sportshandicapper.com currently provides users with various features and services, including statistical review, contests, handicapper picks, and other interactive and non-interactive features, all of which may be updated, deleted, or otherwise modified from time to time at the discretion of Sportshandicapper.com. The Website, the Services, and the Content are provided for your non-commercial entertainment and enjoyment.'],
        ['3. Disclaimer of Warranties', 'YOUR USE OF THE WEBSITE, THE SERVICES AND THE CONTENT IS AT YOUR SOLE RISK. THE WEBSITE, THE SERVICES AND THE CONTENT ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. SPORTSHANDICAPPER.COM EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.'],
        ['4. Limitation of Liability', 'YOU EXPRESSLY UNDERSTAND AND AGREE THAT SPORTSHANDICAPPER.COM SHALL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES RESULTING FROM YOUR USE OF THE WEBSITE, THE SERVICES, OR THE CONTENT.'],
        ...
        ['6. Registration & Background Information', 'In order to use the Services, you may be required to register with Sportshandicapper.com by providing certain information about yourself, including your name and e-mail address. You agree to provide true, accurate, current and complete information about yourself as requested.'],
        ['7. Access by Minors', 'You must be at least 18 years old to register at Sportshandicapper.com. If you are under 18 years of age, you are not permitted to use the Websites or the Services or to access the Content.'],
        ...
        ['10. Indemnity', 'You agree to indemnify, defend and hold harmless Sportshandicapper.com, its directors, owners, employees, and agents from and against any claim or demand, including reasonable attorneys\' fees, arising out of your use of the Website or the Services, or your violation of the TOS.'],
        ['11. Modifications to Website', 'Sportshandicapper.com reserves the right at any time and from time to time to modify or discontinue, temporarily or permanently, the Website or Services (or any part thereof) with or without notice.'],
        ['12. Termination', 'Sportshandicapper.com may, in its sole discretion, terminate your password or use of the Website and/or the Services, and remove and discard any content within the Services, for any reason, including, without limitation, for lack of use or if Sportshandicapper.com believes that you have violated the letter or spirit of the TOS.'],
    ];
    @endphp
    ...
    <div style="margin-bottom:28px;">
        ...
        @else
        <p style="color:#94A3B8;font-size:14.5px;line-height:1.8;font-family:'Inter',sans-serif;">{{ $s[0] }}</p>
        @endif
    </div>
    @endforeach
